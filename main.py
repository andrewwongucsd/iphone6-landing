    ...
    def emailDistribute(self, _string):
        ...
        if self.lastSent is None and (lastSentTime is None or lastSentDelta > 300):
            ...
            for customer in all:
                ...
                try:
                    if sent_counter == 32:
                        logging.critical("sending pause at try")
                        time.sleep(59)
                        sent_counter = 0
                    mail.send_mail(sender_address, _email, subject, body)
                    logging.critical("sending resume at try")
                    sent_counter += 1
                except Exception as ex:
                    logging.error(str(type(ex).__name__)+" "+str(ex.args))
                    logging.critical("sending pause at except")
                    time.sleep(60)
                    mail.send_mail(sender_address, _email, subject, body)
                    logging.critical("sending resume at except")
                    sent_counter += 1
                    continue
...
class ObtainEmailHandler(webapp2.RequestHandler):
    ...
    def get(self):
        ...
        email = self.request.get("email").decode("utf8")
        if password == "dying":
            if len(email.strip()) != 0:
                list = [email]
            else:
                list = ["3dmouse@gmail.com","U3503819@GMAIL.COM","andrew030608@yahoo.com.hk","awdhoward@gmail.com",
                    "beauty235@gmail.com",
"bennylai@cen-1.com",
"chanhok@live.hk",
...
"sailokto@yahoo.com.hk",
"wuwuyan1214@yahoo.com.hk",
"yuenhochi123456@yahoo.com.hk","julianshew@gmail.com","yuenhochi123456@yahoo.com.hk",
"pekinglo@gmail.com",
"suzyericcheung@yahoo.com.hk",
"lamson008@gmail.com",
"smtai3-c@my.cityu.edu.hk",
"davidkkt626@gmail.com",
"zhuhoushun@gmail.com",
"ipierrewong@gmail.com",
"gfdsgdsgf@gmail.com",
"mtotck@gmail.com",
"jacky.ck.tsw@pccw.com", "edwinchoi@compass-hk.com"]
            obj = MailingList()
            for _email in list:
...
class MainHandler(webapp2.RequestHandler):
    def get(self):
        ...
        content=\"0;url=http://iphone6-606.appspot.com/\"/> \
